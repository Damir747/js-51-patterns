...
import { BuilderPages } from "../../builders/builder-page";
...
function Order({
	...
	return BuilderPages.setPromo('Внимание! Акция на продукты! Подробности по телефону 8 900000000').renderForm((text) => {
