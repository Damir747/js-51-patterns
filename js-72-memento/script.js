...
const slogan = document.querySelector('.hero__title');
const buttonEdit = document.getElementById('buttonedit');
const buttonUndo = document.getElementById('buttonundo');

const memento = new Memento();
memento.setValue(slogan.textContent);

buttonEdit.addEventListener('click', () => {
	const newSlogan = prompt('Введите новый слоган');
	slogan.textContent = newSlogan;
});


buttonUndo.addEventListener('click', () => {
	slogan.textContent = memento.getValue();
})
